...
{% endhighlight %}
Мы доказали, что мы можем описать любой алгоритм для наших монад. Но к сожалению этот код чрезвычайно тяжело читать и понимать. Было бы прекрасно если бы мы могли использовать linq query для добавления синтаксического сахара. Давайте глянем на список возможных ключевых слов доступных для определения в linq queries:
